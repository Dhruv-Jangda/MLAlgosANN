...
object DataAnalysis {
  ...
  def main(args: Array[String]): Unit = {
    // Load Data
    val dataFile = new File(".\\data\\Indian Diabetes.csv")
    ...
    val path : Path = Paths.get(".\\data\\Indian Diabetes.csv")
    ...
    HtmlAnalysis.createHtmlAnalysisFile(analysis, new File("C:\\Users\\Netizen\\Documents\\Indian Diabetes.html"))
